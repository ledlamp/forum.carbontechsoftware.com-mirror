...
function smc_Editor(oOptions)
{
	...
	// How big?
	this.sEditWidth = 'sEditWidth' in this.opt ? this.opt.sEditWidth : '100%';
...
smc_Editor.prototype.insertText = function(sText, bClear, bForceEntityReverse, iMoveCursorBack)
{
	...
	else
	{
		...
		if (this.bRichTextEnabled)
		{
			...
			if (oRange != null && oRange.pasteHTML)
			{
			...
			else
			{
				...
				//if (showAlert) {
				//	showAlert = false;
				//	alert("If this does not work, click the Quick Reply text field at the bottom of the page and try again.");
				//}
